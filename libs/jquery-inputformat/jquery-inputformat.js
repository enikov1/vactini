...
$.inputformat = {
	...
	isAllowMaxNumber: function(field){
		return this.getOptions(field).allowMaxNumber;
	},
	...
	replaceAll: function(find, replace, str) {
		...
		var _isAllowMaxNumber = $.inputformat.isAllowMaxNumber(field);	
   ...
   $(this).keydown(function(event){
         ...
         var pos = $.inputformat.getCaretPosition(this);
	 	 ...
	 	 var _isAllowLeadingZero = $.inputformat.isAllowLeadingZero(this);
		   var _isAllowMaxNumber = $.inputformat.isAllowMaxNumber(this);
	 ...
	 if(event.ctrlKey){
		...
		case 49: case 50: case 51: case 52: case 53: case 54:
		  ...
		  if(_isAllowMaxNumber) {
			  var t = value.replace(/,/g, '');
				if(t > _isAllowMaxNumber) {
					value = 0;
				}
			}
